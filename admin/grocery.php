...
<body>
    ...
    <script>
        ...
        document.getElementById('addRowBtn').addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                <td><input type="text" class="form-control" placeholder="Enter item name"></td>
        ...
        document.querySelector('#groceryTable').addEventListener('click', function(e) {
        ...
        document.getElementById('updateBtn').addEventListener('click', function() {
            ...
            // Example: Gather data and send it to the server via AJAX or form submission
            alert('Grocery bill updated!');
        });
    </script>
</body>
</html>
