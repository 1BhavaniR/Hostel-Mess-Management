...
<section id="about-home">
        <h2> HOSTELS FOR WOMENS</h2>
        <p>Our college provides safe and comfortable girls' hostels to ensure a healthy and secured living environment. We have two hostel blocks, each equipped with essential amenities and services to accommodate 350 to 400 students per block.</p>
    </section>
...
<!--     
    ...
    <div class="row mb-5 d-flex align-items-stretch">
        <div class="col-md-4 d-flex">
            <img src="assets/images/hostels/g1.jpeg" class="img-fluid rounded align-self-stretch" alt="Paari Hostel">
        </div>
        <div class="col-md-8">
            <div class="bg-light p-4 shadow rounded h-100">
                <h4>Girls Hostel 1</h4>
...
<br><br>
        ...
        <div class="col-md-4 d-flex">
            <img src="assets/images/hostels/g2.jpeg" class="img-fluid rounded align-self-stretch" alt="Kaari Hostel">
        </div>
    </div>
